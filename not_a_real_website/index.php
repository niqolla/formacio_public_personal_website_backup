...
if(isset($_POST['submit'])) {
    ...
    $newFileName = getUniqueFileName($targetDir, $fileExtension);
    ...
    if ($_FILES["fileToUpload"]["size"] > $maxFileSize) {
        echo "Sorry, your file is too large. Maximum file size is 20 MB.";
        $uploadOk = 0;
    }
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
            // Append the file name and email to the log file
            $logData = $newFileName . "\t" . $email . PHP_EOL;
            ...
            echo "<script>alert('Sorry, there was an error uploading your file. Please reload the page and try again.');</script>";
        }
    }
}

// Function to generate a unique file name with numerical sequence
function getUniqueFileName($directory, $extension) {
    $index = 1;
...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="overlay" >
            ...
            <br><br>
                <div class="container" style="display: flex; "><h1>Is your ticket eligible for a backstage pass?</h1></div>
            </div>
            <br>
            <div class="container">
